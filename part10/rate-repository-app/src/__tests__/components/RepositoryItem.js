...
describe('RepositoryList', () => {
  describe('RepositoryListContainer', () => {
    it('renders repository information correctly', () => {
      ...
      expect(getAllByText('1.6k')[0]).toBeEnabled();
      expect(getAllByText('21.9k')[0]).toBeEnabled();
      expect(getAllByText(repositories.edges[0].node.ratingAverage.toString())[0]).toBeEnabled();
      expect(getAllByText(repositories.edges[0].node.reviewCount.toString())[0]).toBeEnabled();
      ...
      expect(getAllByText('69')[0]).toBeEnabled();
      expect(getAllByText('1.8k')[0]).toBeEnabled();
      expect(getAllByText(repositories.edges[1].node.ratingAverage.toString())[0]).toBeEnabled();
      expect(getAllByText(repositories.edges[1].node.reviewCount.toString())[0]).toBeEnabled();
